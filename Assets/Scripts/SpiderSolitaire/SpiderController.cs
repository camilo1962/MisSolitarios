...
public class SpiderController : MonoBehaviour
{
    ...
    [Header("Las 5 dibujan imágenes, se apagan al hacer clic o se muestran al deshacer.")]
    [SerializeField] GameObject[] drawImages;

    [Header("Las 5 áreas donde se almacenan las cartas que se juegan en drawImages click. Cada área tiene 10 cartas.")]
    [SerializeField] Transform[] drawStorageAreas;
    [SerializeField] int currentDraw = 0;

    [Header("Preconfigure las 104 tarjetas de juego para ahorrar retrasos en la creación de instancias")]
    [SerializeField] Transform cardHolder;
    [SerializeField] SpiderCard[] playingCards;

    [Header("El coche seleccionado actualmente")]
    [SerializeField] SpiderCard lastClicked;

    [Header("El número de palos en el juego. Del 1 al 4 (inclusive)")]
    ...
    private void CheckVictory()
    {
        ...
        string fastestTimesString = "Mejores Tiempos", leastMovesString = "Menos movimientos";
        ...
        string currentScore = "Tiempo: " + timerText.text + "\nMovimientos: " + histories.Count;
