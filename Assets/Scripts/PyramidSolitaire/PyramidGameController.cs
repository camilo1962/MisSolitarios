...
public class PyramidGameController : MonoBehaviour
{
    ...
    private const string SCORE_LABEL = "Puntos : ";
    ...
    private const string TIME_LABEL = "Tiempo : ";
    ...
    private void SetVictory()
    {
        ...
        string fastestTimesString = "Mejores Tiempos", highestScoresString = "Records";
    ...
    private void HandleSelectedCard(Transform child)
    {
        ...
        {
            throw new Exception("La carta en la que se hizo clic no tiene un componente Carta.");
        }
        else
        {
