...
public class KlondikeSolitaire : MonoBehaviour
{
    ...
    [Header("Use estos objetos para rastrear el deshacer si esa configuración está activada")]
    ...
    private void SetVictoryScreen()
    {
        ...
        string fastestTimesString = "Mejores Tiempos", leastMovesString = "Mejores Movimientos";
        ...
        string currentScore = "Tiempo: " + timerText.text + "\nMovimientos: " + (SettingsManager.instance.IsCountUndo() ? countUndoCount : histories.Count); ;
